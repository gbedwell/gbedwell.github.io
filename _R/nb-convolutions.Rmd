...
Evaluation of chunk above to <code>TRUE</code> indicates that there is no material advantage to increasing the number of terms beyond what the function will allow. The function contains built-in checks to ensure that the number of terms is sufficient to give accurate density values. These checks are the same as in [Scott Lundberg's implementation](https://github.com/slundberg/NBConvolution.jl/blob/master/src/furman.jl) in Julia.
    ...
    system.time(
      ...
      system.time(
        sum.saddlepoint2 <- nb_sum_saddlepoint(mus = mus, 
                                               ...
                                               normalize = TRUE))[3],
      system.time(
        sum.saddlepoint.parallel2 <- nb_sum_saddlepoint_parallel(mus = mus,
                                                                 phis = phis2, 
                                                                 counts.start = 0, 
                                                                 counts.end = n.counts2,
                                                                 normalize = TRUE, 
