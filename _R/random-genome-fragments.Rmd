...
A wrapper function, <code>simulate_random_data()</code>, was included in the package that automatically calls all of these functions. See the [source code](https://github.com/gbedwell/xInt/blob/master/R/simulate_random_data.R) for more information.
